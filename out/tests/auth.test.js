...
describe('Testing Auth', function () {
    describe('[POST] /signup', function () {
        it('response should have the Create userData', function () {
            var userData = {
                email: 'oscar1@gmail.com',
                password: 'q1w2e3r4',
            };
            var authRoute = new auth_route_1.default();
            var app = new app_1.default([authRoute]);
            return supertest_1.default(app.getServer()).post(authRoute + "/signup").send(userData);
        });
    });
    describe('[POST] /login', function () {
        it('response should have the Set-Cookie header with the Authorization token', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, supertest_1.default(app.getServer())
    ...
    describe('[POST] /logout', function () {
        it('logout Set-Cookie Authorization=; Max-age=0', function () {
            var authRoute = new auth_route_1.default();
            var app = new app_1.default([authRoute]);
